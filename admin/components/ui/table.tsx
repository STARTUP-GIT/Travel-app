...
function TableHeader({
  ...
  return <thead data-slot="thead" className={cn("[&_tr]:border-b", className)} {...props} />;
}
...
function TableHead({
  ...
  return (
    <th
      data-slot="th"
      className={cn(
        "h-10 px-3 text-left align-middle text-[0.7rem] font-semibold uppercase tracking-wider text-muted-foreground whitespace-nowrap",
        className
      )}
      {...props}
    />
