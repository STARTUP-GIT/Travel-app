  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 border-white/15 shadow-[0_24px_80px_rgb(0_0_0_/_0.5)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-400 backdrop-blur-2xl",
          side === "right" &&
